export default function Sidebar() {
  return (
    <div className="flex">
        ...
        <div className="flex h-screen w-16 flex-col justify-between border-e bg-slate-900">
            <div>
        ...
        <div className="flex h-screen w-40 flex-1 flex-col justify-between border-e bg-slate-100">
            <div className="px-4 py-6">
                <ul className="mt-2 space-y-1">
                    <h1 className="mb-1 text-2xl font-bold text-gray-800">Chamados</h1>
                    <li>
                    <a
                        href=""
